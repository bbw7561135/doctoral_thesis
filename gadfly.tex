...
\begin{document}
\chapter{A pandas-based Framework for Analyzing GADGET Simulation Data\footnote{This chapter has been submitted for publication in PASP (arXiv:1603.05190).}}
...
Additionally, the development of flexible python packages like \code{yt} \citep{Turketal2011b} and \code{pynbody} \citep{Pontzenetal2013}, capable of analyzing and visualizing astrophysical simulation data from several different simulation codes, have greatly improved the ability of computational researchers to perform useful, insight-generating analysis of their datasets.
...
\begin{figure}
\begin{center}
\includegraphics[width=.85\columnwidth]{figures/code_custom_ptypes/code_custom_ptypes}
...
\begin{figure}
\begin{center}
\includegraphics[width=.85\columnwidth]{figures/code_units/code_units}
