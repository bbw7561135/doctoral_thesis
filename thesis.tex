...
The basic process by which the first stars form has been thoroughly established within the standard $\Lambda$CDM model for hierarchical structure formation.
...
growing slowly under the influence of gravity into bound `minihalos,' within which the first stars formed at $z\lesssim50$, initiating a cosmic `renaissance' and marking a significant increase in complexity over the primordial universe \citep{BarkanaLoeb2001, Miralda-Escude2003, Brommetal2009, Loeb2010}.
...
Pop III stars are thus key drivers of cosmic evolution, with a direct impact on the formation and evolution of all subsequent stages of galaxy formation, as the first galaxies are built up from these minihalo progenitors (e.g., \citealt{Bromm2013}).  
...
The characteristic mass of the first stars is crucial, as it largely determines the influence Pop III stars have on their environment, controlling both their total luminosity and ionising radiation output \citep{Schaerer2002}, as well as the details of their eventual demise \citep{Hegeretal2003,HegerWoosley2010,MaederMeynet2012}.


While the formation of the very first stars is set by cosmological initial conditions, the formation of all subsequent generations is much more complex due to the feedback processes initiated by that very first episode of primordial star formation, including the introduction of metals, and possibly dust and significant magnetic fields.
