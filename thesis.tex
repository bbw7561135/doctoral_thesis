...
\chapter{formation under X-ray feedback}
%==============================================================================
...
\begin{figure}
\begin{center}
\includegraphics[width=1\columnwidth]{figures/optical_depth/col_density_fit}
...
\begin{figure}
\begin{center}
\includegraphics[width=1\columnwidth]{figures/khrates/khrates}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{figures/phase_diagrams/temp}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=.9\textwidth]{figures/sinks/sink_masses}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=\textwidth]{figures/structure/disks}
